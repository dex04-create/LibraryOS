...
<div class="row g-3">
  ...
  <div class="col-lg-10 col-md-9">
    ...
    <div class="tab-section" id="tab-genres">
      <div class="panel">
        <div class="section-title"><i class="bi bi-plus-circle me-2"></i>Add New Genre</div>
        <form method="POST" class="row g-2 align-items-end">
    ...
    <div class="tab-section" id="tab-users">
      <div class="panel">
        <div class="section-title"><i class="bi bi-people me-2"></i>User Activity </small></div>
        <div class="table-responsive">
          <table class="table tbl mb-0">
    ...
    <div class="tab-section" id="tab-analytics">
      <div class="row g-3">
        ...
        <div class="col-12">
          <div class="panel">
            <div class="section-title"><i class="bi bi-tags me-2"></i>Books per Genre</div>
