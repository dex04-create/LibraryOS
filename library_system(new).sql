...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2026 at 04:12 PM
...
INSERT INTO `books` (`id`, `title`, `author`, `quantity`, `genre_id`, `created_at`) VALUES
(1, 'PHP & MySQL', 'Jon Duckett', 3, 5, '2026-04-01 01:04:33'),
(2, 'JavaScript', 'Kyle Simpson', 0, 5, '2026-04-01 01:04:33'),
(3, 'Clean Code', 'Robert Martin', 0, 5, '2026-04-01 01:04:33'),
(4, 'Mocking Bird', 'Eminem', 7, NULL, '2026-04-01 01:32:31'),
(5, 'Harry Potter', 'Ako', 0, 6, '2026-04-01 01:33:02'),
(6, 'The Hunger Games', 'Suzume Collins', 19, 1, '2026-04-13 03:19:33');
...
ALTER TABLE `genres`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_genre_name` (`name`);
...
--
ALTER TABLE `books`
  ADD CONSTRAINT `fk_book_genre` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`id`) ON DELETE SET NULL;
